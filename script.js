...
// =============================================
const typingPhrases = [
    '브랜드를 한 문장으로 만들고, 모든 접점에서 같은 목소리로 전달합니다',
    '키메시지·슬로건·배너 카피를 매체 문법에 맞춰 씁니다',
    '헤리티지를 번역하지 않고, 국내 컨텍스트의 브랜드 스토리로 재해석합니다',
    '팝업·플랫폼·캠페인 네이밍으로 발견 포인트를 만듭니다',
    '이커머스·OOH·SNS·PR 카피를 하나의 가이드로 검수합니다'
];
